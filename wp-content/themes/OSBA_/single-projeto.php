...
<main id='mainContent'>
	<div class="page page-single page-project">
		<div class="page-header">
			<div class="page-header-content">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>projetos" class="back-button">
					<i class='icon-angle-left'></i> Voltar para Projetos</a>
		...
		<div class="page-content">
			...
			<div class="other-posts other-projects py-5 mb-5">
				<h2 class="title other-post-title mb-4"> Veja também outros projetos </h2>
						...
						if($lastProjects->have_posts()){ 
							...
							<?php while ( $lastProjects->have_posts() ) : $lastProjects->the_post();
								...
								<div class="col-sm-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.0s">
									<div class="card-link card card-project">
