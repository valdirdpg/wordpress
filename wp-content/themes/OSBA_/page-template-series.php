...
?>
<div class="page page-posts page-series">
	<div class="page-header">
		<h2 class="title page-title">Séries</h2>
	</div>
	<div class="page-content">
		...
		if($lastProjects->have_posts()){ 
			...
			<?php while ( $lastProjects->have_posts() ) : $lastProjects->the_post();
				...
				<div class="serie-post serie-post-abstract post-abstract post">
					<div class="serie-post-wrapper">
						<!-- Caroussel de  post -->
						...
						<div class="serie-content post-content post-abstract-content">
