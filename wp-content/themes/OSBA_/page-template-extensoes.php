<?php
/*
Template Name: EXTENSÕES
*/
get_header();?>
<div class="page page-posts page-extensions">
	<div class="page-header">
		<h2 class="title page-title">Extensões</h2>
	</div>
	<div class="page-content">
		...
		if($lastExtensoes->have_posts()){ 
			...
			<?php while ( $lastExtensoes->have_posts() ) : $lastExtensoes->the_post();
				...
				<div class="extension-post extension-post-abstract post-abstract post">
					<div class="extension-post-wrapper">
						<!-- Caroussel de  post -->
						...
						<div class="extension-content post-content post-abstract-content">
							<div class="extension-header post-header post-abstract-header">
								<h2 class='title post-title'><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
							</div>
							<div class="extension-body post-body post-abstract-body">
